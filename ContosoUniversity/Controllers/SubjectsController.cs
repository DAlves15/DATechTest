...
namespace ContosoUniversity.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SubjectID,CourseID,TeacherID,Title,Credits")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SubjectID,CourseID,TeacherID,Title,Credits")] Subject subject)
        {
            if (ModelState.IsValid)
            {
